...
#### Произведен сбор логов Windows (журнал безопасности, журнал системы)
![Forwarder](screenshots/all_logs.png)
...
| stats count by host
| where count > 3"
![Forwarder](screenshots/4625.png)
![Forwarder](screenshots/logs.png)
...
(Скриншоты добавлены в директорию /screenshots)
